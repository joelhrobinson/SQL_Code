...
-- Could not drop table 'tCustomer' because it is referenced by a FOREIGN KEY constraint
	create table tCustomer
...
alter table tCustomer add c_id int				-- ADD COLUMN	

alter table tCustomer drop city					-- DROP COLUMN
